...
class GPeasantSphinx(object):
    ...
    def __init__(
        ...
        # <root>/pages/gubernia/index.rst
        # <root>/pages/gubernia/<:id>/uezd/index.rst
        # <root>/pages/gubernia/<:id>/uezd/<:id>/locality/index.rst
        # <root>/pages/gubernia/<:id>/uezd/<:id>/volost/<:id>/index.rst
        ...
        # <root>/pages/gubernia/<:id>/uezd/<:id>/volost/<:id>/locality/<:id>/index.rst
